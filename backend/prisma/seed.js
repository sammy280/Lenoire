...
async function main() { 
 ...
 const products = [
    ...
    { name: 'Ballantines bottle', price: 50000, categoryId: cats['Whisky'], preparationTime: 2, description: 'BOTTLE' },
    { name: 'Ballantines 1/4', price: 20000, categoryId: cats['Whisky'], preparationTime: 2, description: 'QUATER' },
    { name: 'Ballantines SHOT', price: 5000, categoryId: cats['Whisky'], preparationTime: 2, description: 'SHOT' },
